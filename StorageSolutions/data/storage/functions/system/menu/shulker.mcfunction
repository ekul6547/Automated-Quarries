...
execute as @s at @s positioned ~ ~0.5 ~ if score @s s_shulker matches 1.. run function storage:system/menu/testhasshulker
...
execute as @s unless score @s s_shulker_pre matches 0 if score @s s_shulker matches 0 run function storage:system/menu/set_navbar
