execute at @s if data block ~ ~0.5 ~ {Items:[{Slot:7b,id:"minecraft:diamond_helmet"}]} run execute positioned ~ ~1 ~ run function quarry:armor/techno/summonhelmet
execute at @s if data block ~ ~0.5 ~ {Items:[{Slot:7b,id:"minecraft:diamond_chestplate"}]} run execute positioned ~ ~1 ~ run function quarry:armor/techno/summonchest
execute at @s if data block ~ ~0.5 ~ {Items:[{Slot:7b,id:"minecraft:diamond_leggings"}]} run execute positioned ~ ~1 ~ run function quarry:armor/techno/summonlegs
execute at @s if data block ~ ~0.5 ~ {Items:[{Slot:7b,id:"minecraft:diamond_boots"}]} run execute positioned ~ ~1 ~ run function quarry:armor/techno/summonboots
