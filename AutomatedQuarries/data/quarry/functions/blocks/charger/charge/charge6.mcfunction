...
execute at @s if score #itemdamage QuarryIgnore matches 1.. store result score #itemdamage qmax_z run data get block ~ ~0.5 ~ Items[{Slot:6b}].tag.Power.damage
...
execute at @s if score #itemdamage QuarryIgnore matches 1.. store result block ~ ~0.5 ~ Items[{Slot:6b}].tag.Damage int 1 run scoreboard players get #itemdamage qmax_z