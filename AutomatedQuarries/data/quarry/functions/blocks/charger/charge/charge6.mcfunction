...
execute as @s at @s if score @s qmin_x matches 5.. run data modify block ~ ~0.5 ~ Items[{Slot:6b}].tag.CustomModelData set value 101
execute as @s at @s if score @s qmin_x matches 1000.. if data block ~ ~0.5 ~ Items[{Slot:6b,id:"minecraft:spider_eye"}] run data modify block ~ ~0.5 ~ Items[{Slot:6b}].tag.CustomModelData set value 102
