...
#Drill durability
execute as @s at @s if data block ~ ~0.5 ~ Items[{Slot:4b,id:"minecraft:diamond_pickaxe",tag:{CustomModelData:101}}] run scoreboard players operation #drill qmin_x = @s qmin_x
execute as @s at @s if data block ~ ~0.5 ~ Items[{Slot:4b,id:"minecraft:diamond_pickaxe",tag:{CustomModelData:101}}] run scoreboard players operation #drill qmin_z = #drill qmax_x
execute as @s at @s if data block ~ ~0.5 ~ Items[{Slot:4b,id:"minecraft:diamond_pickaxe",tag:{CustomModelData:101}}] run scoreboard players operation #drill qmin_z -= #drill qmin_x
execute as @s at @s if data block ~ ~0.5 ~ Items[{Slot:4b,id:"minecraft:diamond_pickaxe",tag:{CustomModelData:101}}] store result block ~ ~0.5 ~ Items[{Slot:4b}].tag.Damage int 1 run scoreboard players get #drill qmin_z