scoreboard players remove #look lookCount 1
...
execute if score #look lookSet matches 0 if score #look lookCount matches 1.. as @s run function lapis:util/look/lookloop