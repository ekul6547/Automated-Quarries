...
execute as @s at @s if score @s t_output matches 0 run function tinkery_data:attribute/feather_falling/test
execute as @s at @s if score @s t_output matches 0 run function tinkery_data:attribute/depth_strider/test
execute as @s at @s if score @s t_output matches 0 run function tinkery_data:attribute/frost_walker/test
execute as @s at @s if score @s t_output matches 0 run function tinkery_data:attribute/jump_boost/test