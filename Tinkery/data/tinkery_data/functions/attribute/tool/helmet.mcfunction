...
execute as @s at @s if score @s t_output matches 0 run function tinkery_data:attribute/feeding/test
execute as @s at @s if score @s t_output matches 0 run function tinkery_data:attribute/respiration/test
execute as @s at @s if score @s t_output matches 0 run function tinkery_data:attribute/aqua_affinity/test
execute as @s at @s if score @s t_output matches 0 run function tinkery_data:attribute/night_vision/test