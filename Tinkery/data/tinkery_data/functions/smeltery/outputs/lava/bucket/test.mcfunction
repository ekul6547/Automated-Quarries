...
execute as @e[type=minecraft:item_frame,tag=t_v_current,limit=1] at @s if score #tinkery t_dum0 matches 180.. positioned ~ ~-0.5 ~ run function tinkery_data:smeltery/outputs/lava/bucket/spawn
