...
execute if data block ~ ~0.6 ~ Items[{Slot:11b,id:"minecraft:paper",tag:{BluePrint:{id:"empty"}}}] run data modify block ~ ~0.6 ~ Items append value {Slot:15b,id:"minecraft:paper",Count:1b,tag:{display:{Name:"{\"text\":\"The 'Why would this do anything?' Blueprint\"}"},CustomModelData:1000,BluePrint:{id:"single",slots:[{s:13b}]}}}
