...
execute at @s if score #tinkertest t_output matches 1 unless data block ~ ~0.6 ~ Items[{Slot:5b,id:"minecraft:string"}] run scoreboard players set #tinkertest t_output 0
execute at @s if score #tinkertest t_output matches 1 unless data block ~ ~0.6 ~ Items[{Slot:12b,id:"minecraft:stick"}] run scoreboard players set #tinkertest t_output 0
...
execute at @s if score #tinkertest t_output matches 1 run data modify block ~ ~0.6 ~ Items append value {Slot:16b,Count:1b,id:"minecraft:bow",tag:{AttributeModifiers:[{AttributeName:"tinkery.maxDurability",Name:"Max Durability",Slot:"mainhand",Amount:448,Operation:0,UUIDMost:36630,UUIDLeast:156724},{AttributeName:"tinkery.durability",Name:"Durability",Slot:"mainhand",Amount:448,Operation:0,UUIDMost:36630,UUIDLeast:156724}],Tinkery:{Material:"wood",Type:"bow",Addons:[],itemdur:382},CustomModelData:1000,display:{Lore:['{"text":"Tinker\'s Enabled","color":"green"}']}}}
