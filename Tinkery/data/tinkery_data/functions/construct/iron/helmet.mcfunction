...
execute at @s if score #tinkertest t_output matches 1 run data modify block ~ ~0.6 ~ Items append value {Slot:16b,Count:1b,id:"minecraft:iron_helmet",tag:{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Slot:"head",Amount:2,Operation:0,UUIDMost:587875,UUIDLeast:59879},{AttributeName:"tinkery.maxDurability",Name:"Max Durability",Slot:"head",Amount:212,Operation:0,UUIDMost:36630,UUIDLeast:156724},{AttributeName:"tinkery.durability",Name:"Durability",Slot:"head",Amount:212,Operation:0,UUIDMost:36630,UUIDLeast:156724}],Tinkery:{Material:"iron",Type:"helmet",Addons:[],itemdur:163},CustomModelData:1000,display:{Lore:['{"text":"Tinker\'s Enabled","color":"green"}']}}}
