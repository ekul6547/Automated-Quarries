...
execute at @s if score #tinkertest t_output matches 1 unless data block ~ ~0.6 ~ Items[{Slot:13b,id:"minecraft:leather"}] run scoreboard players set #tinkertest t_output 0
...
execute at @s if score #tinkertest t_output matches 1 unless data block ~ ~0.6 ~ Items[{Slot:22b,id:"minecraft:leather"}] run scoreboard players set #tinkertest t_output 0
...
execute at @s if score #tinkertest t_output matches 1 run data modify block ~ ~0.6 ~ Items append value {Slot:16b,Count:1b,id:"minecraft:leather_chestplate",tag:{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Slot:"chest",Amount:3,Operation:0,UUIDMost:234453,UUIDLeast:13443},{AttributeName:"tinkery.maxDurability",Name:"Max Durability",Slot:"chest",Amount:96,Operation:0,UUIDMost:36630,UUIDLeast:156724},{AttributeName:"tinkery.durability",Name:"Durability",Slot:"chest",Amount:96,Operation:0,UUIDMost:36630,UUIDLeast:156724}],Tinkery:{Material:"leather",Type:"chestplate",Addons:[],itemdur:78},CustomModelData:1000,display:{Lore:['{"text":"Tinker\'s Enabled","color":"green"}']}}}
