...
execute at @s if score #tinkertest t_output matches 1 run data modify block ~ ~0.6 ~ Items append value {Slot:16b,Count:1b,id:"minecraft:golden_leggings",tag:{AttributeModifiers:[{AttributeName:"generic.armor",Name:"generic.armor",Slot:"legs",Amount:3,Operation:0,UUIDMost:653456,UUIDLeast:63563},{AttributeName:"tinkery.maxDurability",Name:"Max Durability",Slot:"legs",Amount:128,Operation:0,UUIDMost:36630,UUIDLeast:156724},{AttributeName:"tinkery.durability",Name:"Durability",Slot:"legs",Amount:128,Operation:0,UUIDMost:36630,UUIDLeast:156724}],Tinkery:{Material:"gold",Type:"leggings",Addons:[],itemdur:103},CustomModelData:1000,display:{Lore:['{"text":"Tinker\'s Enabled","color":"green"}']}}}
