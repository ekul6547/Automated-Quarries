...
execute at @s if score #tinkertest t_output matches 1 unless data block ~ ~0.6 ~ Items[{Slot:22b,id:"minecraft:gold_ingot"}] run scoreboard players set #tinkertest t_output 0
