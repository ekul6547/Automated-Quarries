...
execute at @s if score #system WorkbenchCount matches 1 run execute unless data block ~ ~0.5 ~ {Items:[{Slot:4b,id:"minecraft:heavy_weighted_pressure_plate"}]} run scoreboard players set #system WorkbenchCount 0
...
execute at @s if score #system WorkbenchCount matches 1 run execute unless data block ~ ~0.5 ~ {Items:[{Slot:7b,id:"minecraft:smithing_table"}]} run scoreboard players set #system WorkbenchCount 0
...
#craft
execute at @s if score #system WorkbenchCount matches 1 run function tinkery:wbrecipes/constructor_craft