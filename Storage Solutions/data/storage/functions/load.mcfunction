...
tellraw @a ["",{"text":"Loaded "},{"text":"[Storage Solutions] v0.3","color":"gold","clickEvent":{"action":"run_command","value":"/trigger StorageBook"},"hoverEvent":{"action":"show_text","value":"Click here to get the tutorial book"}},{"text":" By RE:Lapis","color":"gray"}]