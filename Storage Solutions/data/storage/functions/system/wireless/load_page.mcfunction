...
execute as @s at @s if score @s s_shulker matches 1.. run data modify entity @s Items[{Slot:8b}].tag.TEMPITEM set from entity @s Items[{Slot:17b}]
...
execute as @s at @s if score @s s_shulker matches 1.. run data modify entity @s Items[{Slot:17b}] set from entity @s Items[{Slot:8b}].tag.TEMPITEM
#CLEAR TEMPITEM
data modify entity @s Items[{Slot:8b}].tag.TEMPITEM set value {}