...
execute if score #bores.hasmined const matches 0 if score #bores.minecount const matches ..4 positioned ~1 ~ ~ run function bores:bore/while_active/mine/mine_ns