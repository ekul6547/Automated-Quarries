...
execute at @s if score #system WorkbenchCount matches 1 run execute unless data block ~ ~0.5 ~ {Items:[{Slot:3b,id:"minecraft:diamond_pickaxe"}]} run scoreboard players set #system WorkbenchCount 0
...
execute at @s if score #system WorkbenchCount matches 1 run execute unless data block ~ ~0.5 ~ {Items:[{Slot:5b,id:"minecraft:diamond_pickaxe"}]} run scoreboard players set #system WorkbenchCount 0
...
execute at @s if score #system WorkbenchCount matches 1 run execute unless data block ~ ~0.5 ~ {Items:[{Slot:7b,id:"minecraft:diamond_pickaxe"}]} run scoreboard players set #system WorkbenchCount 0
...
execute at @s if score #system WorkbenchCount matches 1 positioned ~ ~1 ~ run function bores_recipes:elite/create